...
CivicSignal is a civic safety and risk intelligence platform that transforms citizen reports and public online signals into a live civic risk map.
...
- Support moderation, false-alarm handling, community verification, and demo mode.
...
`NEXT_PUBLIC_MAP_STYLE_URL` is optional. When it is not set, CivicSignal uses free OpenStreetMap raster tiles for the local demo map; when it is set, MapLibre loads that style URL.
